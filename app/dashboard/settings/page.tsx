...
export default function SettingsPage() {
  ...
  const [email, setEmail] = useState(user?.primaryEmailAddress?.emailAddress || "alex@example.com");
  const [phone, setPhone] = useState("+1 (555) 123-4567");
  const [address, setAddress] = useState("123 Financial Ave, New York, NY 10004");
            ...
            <Card className="border-border mt-4">
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { bank: "Chase Bank", number: "•••• 4421", verified: true },
                    { bank: "Bank of America", number: "•••• 8890", verified: true },
                  ].map((link, i) => (
                    <div
                      key={i}
