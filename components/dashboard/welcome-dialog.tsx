            ...
            <div className="relative overflow-hidden rounded-2xl border border-border bg-bg-card shadow-2xl">
              ...
              <div className="relative p-6 sm:p-8">
                ...
                <motion.div
                  ...
                  className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary/80 shadow-lg shadow-primary/30"
                >
                ...
                >
                  <div className="mb-2 inline-flex items-center gap-1.5 rounded-full border border-accent-gold/20 bg-accent-gold/5 px-3 py-1">
                    ...
                    <span className="text-[11px] font-semibold text-accent-gold uppercase tracking-wider">
                      Account Created
                    </span>
                  </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-border bg-bg-surface/50 p-3.5">
                    ...
                    <div className="rounded-xl border border-border bg-bg-surface/50 p-3.5">
                      ...
                      <p className="mt-0.5 text-sm font-medium text-text-primary capitalize">
                ...
                <motion.div
                  ...
                  className="mt-4 flex items-start gap-2 rounded-xl border border-accent-gold/20 bg-accent-gold/5 p-3"
                >
                  ...
                  <p className="text-xs text-text-secondary leading-relaxed">
                    ...
                    account number or POV codes with anyone. StateBank will never
                    ask for your password or POV codes via email or phone.
                  </p>
                </motion.div>
                ...
                >
                  <Button
                    onClick={handleGoToDashboard}
                    className="w-full h-12 rounded-xl text-base font-semibold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30"
                  >
                    Go to Dashboard
